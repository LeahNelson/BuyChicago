                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                var html = '<div id="propdetail-window">'
                                    ...
                                    +
                                    '<div class="thumbnail">'
                                    // https: //gis1.cookcountyil.gov/cookviewer/PhotoProxy.aspx?25214140140000=
                                    +
                                    '<img src="https://gis1.cookcountyil.gov/cookviewer/PhotoProxy.aspx?' + response[0].pin + '=" a>' +
                                    '<div class="caption">' +
                                    '<h3>' + 'Property Detail' + '</h3>' +
                                    '<h4>' + response[0].location + '</h4>' +
                                    '<p>' + 'Zoning Classification: ' + response[0].zoningClassification + '</p>' +
                                    '<p>' + 'Ward: ' + response[0].ward + '</p>' +
                                    '<p>' + 'Community Area: ' + response[0].communityArea + '</p>' +
